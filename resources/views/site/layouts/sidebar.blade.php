<div class="geex-sidebar">
    ...
    <div class="geex-sidebar__wrapper">
        <div class="geex-sidebar__header">
            <a href="{{ route('user.account') }}" class="geex-sidebar__logo">
                <img class="logo-lite" src="/site/assets/img/harcabillogo.png" alt="logo" />
                ...
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu">
                        <li class="geex-sidebar__menu__item">
                            <a href="{{ route('user.expenses.index') }}" class="geex-sidebar__menu__link">Harcamalar</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="#" class="geex-sidebar__menu__link">Gelirler</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="geex-sidebar__footer">
            <span class="geex-sidebar__footer__title">Ne Harcadığını Bil Bütçeni Yönet</span>
            <p class="geex-sidebar__footer__copyright">© 2024 All Rights Reserved</p>
            <p class="geex-sidebar__footer__author">Made with <span class="heart-icon">♥</span> by <a href="#">HarcaBil</a></p>
        </div>
    </div>
</div>
