...
<head>
    ...
    <title>Giriş Yap - Harcabil</title>
...
<main class="geex-content">
    <div class="geex-content__authentication">
        <div class="geex-content__authentication__content" style="padding: 20px">
            <div class="geex-content__authentication__content__wrapper">
                ...
                <form id="signInForm" action="{{ route('user.checklogin') }}" class="geex-content__authentication__form" method="post">@csrf
                    <h2 class="geex-content__authentication__title">Giriş Yap 👋</h2>
                    <div class="geex-content__authentication__form-group">
                        <label for="emailSignIn">Email</label>
                        <input type="email" id="emailSignIn" name="email" placeholder="E-mail bilginizi giriniz" required>
                    ...
                    <div class="geex-content__authentication__form-group">
                        ...
                        <input type="password" id="loginPassword" name="password" placeholder="Şifrenizi giriniz" required>
                    ...
                    <div class="geex-content__authentication__form-group custom-checkbox">
                        ...
                        <label class="geex-content__authentication__checkbox-label" for="rememberMe">Beni Hatırla</label>
                    </div>
                    <button type="submit" class="geex-content__authentication__form-submit">Giriş Yap</button>
                    ...
                    <div class="geex-content__authentication__form-footer">
                        Hesabınız yok mu? <a href="{{ route('user.register') }}">Kayıt ol</a>
                    </div>
                </form>
            </div>
        </div>
